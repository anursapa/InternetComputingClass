        ...
        <div class="row">
            ...
            <div class="col-md-10">
                <div class="row">
                    ...
                    if(isset($_GET['id'])){
                      for ($i=0; $i < 15; $i++){
                        if($_GET['id']==$images[$i]['id']){
                          echo   '<div class="col-md-8">
                                <img class="img-responsive" src="images/medium/'.$images[$i]['path'].'" alt="'.$images[$i]['description'].'">
                                ...
                                <div class="panel panel-default">
                                    <div class="panel-body">
                                        <ul class="details-list">
                                            <li>By: <a href="#">'.$images[$i]['user'].'</a></li>
                                            <li>Country: <a href="#">'.$images[$i]['country'].'</a></li>
                                            <li>City: <a href="#">'.$images[$i]['city'].'</a></li>
                                            <li>Taken on: '.$images[$i]['taken'].'</li>
                                        </ul>
                                    </div>
                                </div>';}}
                        }
                        ...
                        /* you will need to replace this hard-coded data with appropriate PHP */ ?>
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="panel panel-default">
                            <div class="panel-body" id="tags">
                                <?php for ($j=0; $j < count($images[$i]['tags']); $j++) {
                                  echo '<span class="label label-default">'.$images[$i]['tags'][$j].'</span>';
                                }?>
