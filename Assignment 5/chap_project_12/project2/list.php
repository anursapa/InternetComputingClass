...
//   echo '<li><a href="detail.php?id='.$images[]
// }
if(isset($_GET['country'])){
  for ($i=0; $i < 15; $i++){
    if($_GET['country']==$images[$i]['country']){
      echo '<li>
        <a href="detail.php?id='.$images[$i]['id'].'" class="img-responsive">
      <img src="images/square/'.$images[$i]['path'].'" alt="'.$images[$i]['description'].'">
      <div class="caption">
      <div class="blur"></div>
      <div class="caption-text">
      <h1>'.$images[$i]['description'].'</h1>
      </div>
      </div>
            </a>
      </li>';}
  ...
  foreach ($images as $firstD => $secondD) {
  // echo '<a>Fuck<img src="images/square/'.$secondD['path'].'" alt="'.$secondD['description'].'"></a>';
    // echo '<li><a href="detail.php?id='.$secondD['id'].'" class="img-responsive>';
    // echo '<img src="images/square/'.$secondD['path'].'" alt="'.$secondD['description'].'">';
    // echo '<div class="caption"><div class="blur"></div><div class="caption-text"><h1>'.$secondD['description'].'</h1></div></div></a></li>';
    echo '<li>
      <a href="detail.php?id='.$secondD['id'].'" class="img-responsive">
<img src="images/square/'.$secondD['path'].'" alt="'.$secondD['description'].'">
<div class="caption">
<div class="blur"></div>
<div class="caption-text">
  <h1>'.$secondD['description'].'</h1>
</div>
</div>
          </a>
</li>';
