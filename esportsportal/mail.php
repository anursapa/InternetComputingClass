...
//    $mail->addAttachment('/tmp/image.jpg', 'new.jpg');    // Optional name
    ...
    $mail->Body = 'Congratulations! You subscribed for a coaching session with Johan Sundstein. To contact with the coach regarding the session please use the following discrord account details: Zerg#8715';
