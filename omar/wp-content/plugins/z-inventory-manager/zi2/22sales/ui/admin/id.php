...
class ZI2_22Sales_Ui_Admin_Id
{
	private function _import(
		ZI2_22Sales_Data_Repo $repo,

		ZI2_22Sales_Ui_Status $viewStatus,
	...
	public function menu( $slug, $id )
	{
		...
		if( $model->isDraft() ){
			...
			if( $model->shipments ){
				$return[] = array( '../shipments', '&#9776; ' . '__Shipped Items__' );
			}

			$toShip = $model->getItemsToShip();
			if( $toShip ){
				$return[] = array( '../shipments/new', '&rarr; ' . '__Ship Items__' );
			}
		}
...
<?php 
	...
	public function renderEdit( ZI2_22Sales_Data_Model $model )
	{
