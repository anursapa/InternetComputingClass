...
class ZI2_21Purchases_Ui_Admin_Id_Receipts
{
	...
	public function render( ZI2_21Purchases_Data_Model $model )
	{
		...
		foreach( $model->lines as $e ){
			...
			$toReceive[ $e->item->id ] = $e->qty;
		}

		foreach( $model->receipts as $r ){
...
?>
	...
	<?php if( $model->lines ) : ?>
		<div>
			<div class="hc-flex-auto-grid">
				<div>__Title__</div>
				<div>__Ordered__</div>
				<div>__Received__</div>
				<div>__To Receive__</div>
			</div>
		</div>
	<?php endif; ?>
	...
	<?php if( $model->receipts ) : ?>
		<h2>__Purchase Receipts__</h2>
	<?php endif; ?>

	<?php foreach( $model->receipts as $e ) : ?>
		<div class="hc-mb3">
			<div class="hc-my1">
