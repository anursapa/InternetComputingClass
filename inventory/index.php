...
<?php include_once "header.inc.php" ?>
  <main role="main" class="container">
    <div class="jumbotron">
    <h1>Loan equipment</h1>
    <p class="lead">Please enter GWID to retrieve data info on university member to loan equipment</p>
    ...
    if(isset($_POST['submit'])) {
      ...
      if (mysqli_num_rows($result) > 0) {
       ...
       while($row = mysqli_fetch_assoc($result)) {
          $_SESSION['idD'] = $row['id'];
           echo "<a href='equipmentlist.php'>".$row["firstname"] ." ". $row["lastname"]."</a>";
