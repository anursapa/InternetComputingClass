...
<div id="admin-main-control" class="col-md-10 p-x-3 p-y-1">
    ...
    <div class="row justify-content-center">
        <div class="col-2">
            <p>Dota 2</p>
            <a href="coaches_dota.php"><img src="img/dota-logo.png" width="100px" height="100px" alt=""></a>
            </div>
        <div class="col-2">
            <p>League of Legends</p>
            <a href="coaches_lol.php"><img src="img/lol-logo.png" width="100px" height="100px" alt=""></a>
        </div>
        <div class="col-2">
            <p>Other platforms</p>
            <a href="coaches_others.php"><img src="img/logo.png" width="100px" height="100px" alt=""></a>
        </div>
      </div>
      <hr>
      <p>🔥Popular coaches</p>
      <div class="row justify-content-start">
          ...
          <div class="col-4">
              ...
              <img src="img/faker.jpg" width="100px" height="100px" alt=""></div>
          <div class="col-2">
              <p>$79.99/hour</p>
              <a href="signin.php"><button class="btn btn-outline-dark" type="submit">Book now</button></a>
          </div>
