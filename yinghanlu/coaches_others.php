...
<div id="admin-main-control" class="col-md-10 p-x-3 p-y-1">
    ...
    <div class="row justify-content-start">
        <div class="col-4">
            <p>Summit1G</p>
            <p>Field: PUBG PC</p>
            <img src="img/summit1g.jpeg" width="100px" height="100px" alt=""></div>
        <div class="col-2">
            <p>$79.99/hour</p>
        ...
        <div class="col-4">
            <p>Bugha</p>
            <p>Field: Fornite</p>
            <img src="img/bugha.jpg" width="100px" height="100px" alt=""></div>
        <div class="col-2">
            <p>$79.99/hour</p>
            <a href="signin.php"><button class="btn btn-outline-dark" type="submit">Book now</button></a>
        </div>
    ...
    <div class="row justify-content-start">
        <div class="col-4">
            <p>S1mple</p>
            <p>Field: CSGO</p>
            <img src="img/s1mple.jpg" width="100px" height="100px" alt=""></div>
        <div class="col-2">
            <p>$79.99/hour</p>
            <a href="signin.php"><button class="btn btn-outline-dark" type="submit">Book now</button></a>
        </div>
