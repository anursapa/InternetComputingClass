...
<nav class="navbar navbar-expand-lg navbar-light bg-light mb-4">
  ...
  <div class="collapse navbar-collapse" id="navbarCollapse">
    <ul class="navbar-nav mr-auto">
        ...
        <li class="nav-item">
            <a class="nav-link" href="http://www.dota2.com/heroes/"><img src="img/dota-logo.png" width="30" height="30" alt=""> Dota 2</a>
        </li>
        <li class="nav-item">
            <a class="nav-link"></a>
        </li>
      ...
      <li class="nav-item">
        <a class="nav-link" href="https://na.leagueoflegends.com/en-us/champions/"><img src="img/lol-logo.png" width="30" height="30" alt=""> League of Legends</a>
      </li>
...
<div class="container-fluid">
    <div class="row">
        ...
        <div id="admin-main-control" class="col-md-10 p-x-3 p-y-1">
            ...
            <p class="display-4">League of Legends Heros</p>
